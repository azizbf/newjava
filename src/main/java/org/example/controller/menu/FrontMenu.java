...
public class FrontMenu {
    ...
    private void initialize() {
        ...
        buttonPathMap.put(coursesButton, null); // Not implemented yet
        buttonPathMap.put(webinarsButton, null); // Not implemented yet
        buttonPathMap.put(competitionsButton, null); // Not implemented yet
        buttonPathMap.put(profileButton, "user/AfficherUser.fxml");
    ...
    private void handleButtonClick(Button clickedButton) {
        ...
        if (fxmlPath != null) {
            ...
            showComingSoonMessage(clickedButton.getText());
        }
    }
    
    /**
     * Shows a "coming soon" message for features not yet implemented
     */
    private void showComingSoonMessage(String featureName) {
        VBox messageBox = new VBox(10);
        messageBox.setStyle("-fx-alignment: center; -fx-padding: 20;");
        
        Label titleLabel = new Label(featureName + " Coming Soon!");
        titleLabel.setStyle("-fx-font-size: 24px; -fx-font-weight: bold;");
        
        Label messageLabel = new Label("This feature is currently under development and will be available soon.");
        messageLabel.setStyle("-fx-font-size: 16px; -fx-text-fill: #666;");
        messageLabel.setWrapText(true);
        
        messageBox.getChildren().addAll(titleLabel, messageLabel);
        
        // Center the message box in the content pane
        ...
        contentPane.getChildren().add(messageBox);
        
        // Play fade-in animation
        FadeTransition fadeIn = new FadeTransition(Duration.millis(250), messageBox);
    ...
    /**
     * Shows an error message when FXML loading fails
     */
    private void showErrorMessage(String errorMessage) {
        ...
        titleLabel.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: #e74c3c;");
