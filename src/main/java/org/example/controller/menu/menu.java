...
public class menu {
    ...
    private void initialize() {
        ...
        addButtonStyleHandlers(projectButton);
        addButtonStyleHandlers(applicationsButton);
    }
    ...
    private void handleProjectButton() {
        handleButtonClick(projectButton);
    }
    
    private void handleApplicationsButton() {
        handleButtonClick(applicationsButton);
    }
